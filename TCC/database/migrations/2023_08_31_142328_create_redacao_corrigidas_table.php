...
return new class extends Migration
{
    ...
    {
        Schema::create('redacao_corrigidas', function (Blueprint $table) {
            $table->increments('id_redacao_corrigida');
    ...
    {
        Schema::dropIfExists('redacao_corrigidas');
    }
};
